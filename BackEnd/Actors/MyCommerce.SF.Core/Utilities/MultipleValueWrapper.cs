...
{
    public class SingleValueWrapper<T> : StateValueWrapperBase<T>
    {
        private readonly Func<T> _newValueConstructor;

        /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
        public SingleValueWrapper(string name, Func<T> newValueConstructor, IActorStateManager stateManager)
